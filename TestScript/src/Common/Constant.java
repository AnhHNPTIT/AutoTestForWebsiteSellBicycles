...
public final class Constant {
	...
	public static String BASE_URL		 		= "https://xedaptotnhat.vn/";

	// User name and password to access website
	public static String BASE_PHONE 			= "0978478178";
	public static String BASE_PASSWORD			= "12345678";
	public static String BASE_USERNAME 			= "Đại lý xe Bình Minh";
