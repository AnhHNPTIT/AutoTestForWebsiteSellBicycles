...
public class ChangePasswordScreen {
	...
	public static String updateBtn						= "//button[contains(text(),'Cập nhật')]";
	...
	public static WebDriver openScreen(String browser) {
		...
		if (!browser.isEmpty()) {
			...
			Utilities.clickObscuredElement(driver, By.xpath(HomeScreen.changePasswordLinkXpath), By.xpath(ChangePasswordScreen.updateBtn), Constant.WAIT_ELEMENT_EXIST);
		}
		return driver;
	}
	...
	public static void changePassword(WebDriver driver, String oldPassword, String newPassword, String newPasswordConfirm, String expectErrMsg) {
		...
		Utilities.click(driver, By.xpath(updateBtn));
